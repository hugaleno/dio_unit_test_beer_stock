...
public class BeerControllerTest {
  ...
  void whenPATCHIsCalledWithInvalidBeerIdToIncrementThenNotFoundStatusIsReturned()
    ...
    mockMvc
        .perform(patch(BEER_API_URL_PATH + "/" + INVALID_BEER_ID + BEER_API_SUBPATH_INCREMENT_URL)
            .contentType(MediaType.APPLICATION_JSON)
  ...
  void whenPATCHIsCalledWithInvalidBeerIdToDecrementThenNotFoundStatusIsReturned()
    ...
    when(beerService.decrement(INVALID_BEER_ID, quantityDTO.getQuantity()))
        .thenThrow(BeerNotFoundException.class);
    mockMvc
        .perform(patch(BEER_API_URL_PATH + "/" + INVALID_BEER_ID + BEER_API_SUBPATH_DECREMENT_URL)
            .contentType(MediaType.APPLICATION_JSON)
            .content(asJsonString(quantityDTO)))
        .andExpect(status().isNotFound());
  }
